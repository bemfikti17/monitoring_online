    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <li><a href="subjektif.php"><i class="fa fa-pencil-square-o"></i> Penilaian Subjektif Proker</a></li>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo "$jumreq"; ?></h3>

              <p>Perminataan Aktivasi Akun</p>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars "></i>
            </div>
            <a href="aktivasiakun.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
