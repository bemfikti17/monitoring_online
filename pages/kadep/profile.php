      ...
      <div class="row">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>NPM</b> <a class="pull-right"><?php echo "$npm"; ?></a>
                </li>
                <li class="list-group-item">
                  <b>Bidang</b> <a class="pull-right">Bidang <?php echo "$bidang"; ?></a>
                </li>
                </ul>
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-9">
          ...
          <div class="box-header with-border">
            ...
            <?php include ('../include/gantipw.php') ?>
            <!-- /.box-body -->
          </div>
        </div>
      </div>
